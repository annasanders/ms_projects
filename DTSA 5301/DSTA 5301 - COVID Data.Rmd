...
co %>% filter(county %in% co_top_pop_counties) %>%
  ...
  geom_abline(mapping=aes(intercept=summary(mod_death_p_thou_top)$coefficients[1],slope=summary(mod_death_p_thou_top)$coefficients[2]), col = 'black', linetype = 2, size=1) +
  geom_abline(mapping=aes(intercept=summary(mod_death_p_thou)$coefficients[1],slope=summary(mod_death_p_thou)$coefficients[2]), col = 'grey', linetype = 2, size=1)
...
```{r}
summary(mod_death_p_thou_top)$coefficients[2]
summary(mod_death_p_thou)$coefficients[2]
```
